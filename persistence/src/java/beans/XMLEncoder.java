...
public class XMLEncoder extends Encoder { 
    ...
    public void setOwner(Object owner) { 
        ...
        this.owner = owner; 
	/*
	  We have to become internal for this phase otherwise 
	  this will result in writing this value (the owner) 
	  to the output stream as if it were the value from 
	  a writeObject() call. Instead, we just want to 
	  register an an expression for the owner, in case 
	  the object graph contains a reference to it. 
        */
	internal = true; 
    ...
    private void mark(Object o, boolean isArgument) { 
        ...
        if (o == null || o.getClass() == String.class || o == this) { 
            return; 
        }
    ...
    public void writeExpression(Expression oldExp) { 
    	// System.out.println("XMLEncoder::writeExpression: " + oldExp); 
    ...
    private void outputValue(Object value, Object outer, boolean isArgument) { 
        ...
        if (value instanceof Number || value instanceof Boolean) { 
            String primitiveTypeName = Expression.primitiveTypeFor(value.getClass()).getName(); 
