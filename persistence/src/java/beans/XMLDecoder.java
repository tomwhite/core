...
class ObjectHandler extends HandlerBase {
    ...
    private boolean isPrimitive(String name) { 
        return name != "void" && Expression.typeNameToClass(name) != null; 
    }
    ...
    public void startElement(String name, AttributeList attrs) throws SAXException { 
        ...
        if (name == "void") { 
            ...
            e.addArg(e.getTarget()); // The class attribute means sub-type for arrays. 
            e.setTarget(java.lang.reflect.Array.class); 
            e.addArg(new Integer(length == null ? "0" : length)); 
        } 
        else if (name == "java") { 
            ...
            simulateException("Unrecognised opening tag: " + name + " " + attrsToString(attrs)); 
	    return; 
        } 
    ...
    public void endElement(String name) throws SAXException {
        ...
        if (name == "object" || name == "array" || name == "void") { 
            ...
            simulateException("Unrecognised closing tag: " + name);
        }
    }
}
